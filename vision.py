# https://github.com/gokmavisianka/ShadowCasting/tree/main
# https://www.youtube.com/watch?v=AjPPhx8-lXg

import pygame
import numpy as np

### MAIN FAILI VIST TULEB PANNA
...
light_source = LightSource(position=(400, 400), shadow_color=(0, 0, 0), display=screen)
